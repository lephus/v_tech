...
class AddAssembleView extends GetView<OrderAssembleController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Thêm đơn hàng lắp ráp'),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Obx(()=>
          controller.isLoadAddAssemble.value ?
              Center(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async{
          Get.back();
          await controller.AddOrderAssemble();
          ...
          body: SafeArea(
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child:Obx(()=>
                      controller.isInputSearchProduct.value ?
                      Center(child: CircularProgressIndicator(),):
                      Scrollbar(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: IconButton(
                      onPressed: (){
                        controller.isInputSearchLapRap.value = true;
                        controller.isInputSearchLapRap.value = false;
                      },
                      icon: Icon(Icons.search, color:Colors.blue),
                    )
                  )
